function [Packet_Block,Decoded_Packet,Packet_Error_2] = Packet_enc_dec_2(K, N, i2)
...
%--------------------------------
 try
    %for il = 1:1:C
        ...
        Packet_Error_2 = isequal(Packet_Block, Decoded_Packet);
        Packet_Error_2 = ~Packet_Error_2;
    %end
    catch
        Decoded_Packet = 0;
        Packet_Error_2 = isequal(Packet_Block, Decoded_Packet);
