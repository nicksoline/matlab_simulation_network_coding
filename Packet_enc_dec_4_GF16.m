function [Packet_Block,Decoded_Packet,Packet_Error_4_GF16] = Packet_enc_dec_4(K, N, i4)
...
%--------------------------------
 try
    %for il = 1:1:C
        ...
        Packet_Error_4_GF16 = isequal(Packet_Block, Decoded_Packet);
        Packet_Error_4_GF16 = ~Packet_Error_4_GF16;
    %end
    catch
        Decoded_Packet = 0;
        Packet_Error_4_GF16 = isequal(Packet_Block, Decoded_Packet);
