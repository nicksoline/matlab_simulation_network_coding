function [Packet_Block,Decoded_Packet,Packet_Error_1] = Packet_enc_dec(K, N, i1)
...
%--------------------------------
    ...
    %for il = 1:1:C
        ...
        Packet_Error_1 = isequal(Packet_Block, Decoded_Packet);
        Packet_Error_1 = ~Packet_Error_1;
    %end
    catch
        Decoded_Packet = 0;
        Packet_Error_1 = isequal(Packet_Block, Decoded_Packet);
